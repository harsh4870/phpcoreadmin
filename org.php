...
$org = $db->arraybuilder()->paginate("org", $page, $select);
    ...
    <div class="row">
        ...
        <div class="col-lg-6" style="">
            <div class="page-action-links text-right">
	            <a href="add_org.php?operation=create">
        ...
        <tbody>
            <?php foreach ($org as $row) : ?>
                <tr>
	                ...
	                <td>
					<a href="edit_org.php?org_id=<?php echo $row['id'] ?>&operation=edit" class="btn btn-primary" style="margin-right: 8px;"><span class="glyphicon glyphicon-edit"></span>
					...
					<a href=""  class="btn btn-danger delete_btn" data-toggle="modal" data-target="#confirm-delete-<?php echo $row['id'] ?>" style="margin-right: 8px;"><span class="glyphicon glyphicon-trash"></span></td>
					 ...
					 <div class="modal fade" id="confirm-delete-<?php echo $row['id'] ?>" role="dialog">
					    <div class="modal-dialog">
					      <form action="org_delete.php" method="POST">
					      <!-- Modal content-->
    ...
    <div class="text-center">
        ...
        if ($total_pages > 1) {
            ...
            for ($i = 1; $i <= $total_pages; $i++) {
                ...
                echo '<li' . $li_class . '><a href="org.php' . $http_query . '&page=' . $i . '">' . $i . '</a></li>';
            }
            echo '</ul></div>';
        }
        ?>
