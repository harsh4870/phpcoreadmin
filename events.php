    ...
    <div class="row">
        ...
        <div class="col-lg-6" style="">
            <div class="page-action-links text-right">
	            <a href="add_event.php?operation=create">
        ...
        <tbody>
            <?php foreach ($customers as $row) : ?>
                <tr>
	                ...
	                <td>
					<a href="edit_event.php?customer_id=<?php echo $row['id'] ?>&operation=edit" class="btn btn-primary" style="margin-right: 8px;"><span class="glyphicon glyphicon-edit"></span>
    ...
    <div class="text-center">
        ...
        if ($total_pages > 1) {
            ...
            for ($i = 1; $i <= $total_pages; $i++) {
                ...
                echo '<li' . $li_class . '><a href="events.php' . $http_query . '&page=' . $i . '">' . $i . '</a></li>';
            }
            echo '</ul></div>';
        }
        ?>
