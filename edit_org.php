...
{
    //Get org id form query string parameter.
    $org_id = filter_input(INPUT_GET, 'org_id', FILTER_SANITIZE_STRING);
    ...
    $db = getDbInstance();
    $db->where('id',$org_id);
    $stat = $db->update('org', $data_to_update);
...
<div id="page-wrapper">
    ...
    <form class="" action="" method="post" enctype="multipart/form-data" id="contact_form">
        ...
        <?php
            ...
            require_once('./forms/org_form.php'); 
        ?>
    </form>
</div>
